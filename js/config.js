...
// Пауза між повідомленнями черги суфлера/бігучки: наступне старту'є не одразу
// по завершенню попереднього, а з невеликою затримкою (ms) — для «дихання» між фразами.
export const MOTION_QUEUE_GAP_MS = 600;
